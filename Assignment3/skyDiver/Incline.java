...
public class Incline extends JPanel {
    ...
    //calculated from running the main method of SkyDiver.java
    ...
    int sleepTime = 10;         // For animation.
    ...
    SkyDiver mySkyDiver = new SkyDiver(((double)timeStep/1000), deployTime/1000);
	stopped = false;
	time = 0;
