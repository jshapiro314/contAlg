...
public class Queue {
    ...
    Stats myStatsInterarrival;
    Stats myStatsTimeInSystem;
    ...
    void init ()
    {
        ...
        myStatsInterarrival = new Stats();
        myStatsTimeInSystem = new Stats();
        scheduleArrival ();
    }
	...
	Customer c = queue.removeFirst ();
        ...
        myStatsTimeInSystem.add(timeInSystem);
    ...
    double interarrivalTime = randomInterarrivalTime();
    double nextArrivalTime = clock + interarrivalTime;
    //Add interarrival time
    myStatsInterarrival.add(interarrivalTime);
    ...
    public static void main (String[] argv)
    {
        ...
        System.out.println("\n\nMean Interarrival Statistics:");
        System.out.println(queue.myStatsInterarrival);
        System.out.println("\n\nMean Time in System Statistics:");
        System.out.println(queue.myStatsTimeInSystem);
