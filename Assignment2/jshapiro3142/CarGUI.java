...
public class CarGUI extends JPanel {
    ...
    void setScene ()
    {
        ...
        if (sceneStr.equals("Scene 1")) {
            ...
            endX = 550;
            endY = 50;
            obstacles.add (new Rectangle2D.Double(100,45,400,45));
            obstacles.add (new Rectangle2D.Double(100,170,400,115));
            obstacles.add (new Rectangle2D.Double(100,295,400,100));
        }
        else {
